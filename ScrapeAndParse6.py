...
def main():
    ...
    try:
        ...
        field_to_investigate = input("\nEnter the field you want to investigate: ").strip()
        if field_to_investigate in all_keys:
            print(f"\nData for field '{field_to_investigate}':")
            print(json.dumps(data[field_to_investigate], indent=4))
        else:
            print(f"Field '{field_to_investigate}' not found.")
